...
- Spec conformant — Full v3.0.3 test suite (358/358 tests passing)
...
This implementation follows the [official TOON v3.0 specification](https://github.com/toon-format/spec/blob/main/SPEC.md) with extensive conformance testing (358/358 tests passing). Key features:
