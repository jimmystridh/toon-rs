pub struct StructVariantSerializer { map: Map<String, Value>, name: String }
...
impl Serializer for &mut ValueSerializer {
    ...
    fn serialize_i8(self, v: i8) -> Result<Self::Ok, Self::Error> { Ok(Value::Number((v as i64).into())) }
    fn serialize_i16(self, v: i16) -> Result<Self::Ok, Self::Error> { Ok(Value::Number((v as i64).into())) }
    fn serialize_i32(self, v: i32) -> Result<Self::Ok, Self::Error> { Ok(Value::Number((v as i64).into())) }
    fn serialize_i64(self, v: i64) -> Result<Self::Ok, Self::Error> { Ok(Value::Number(v.into())) }
    fn serialize_u8(self, v: u8) -> Result<Self::Ok, Self::Error> { Ok(Value::Number((v as u64).into())) }
    fn serialize_u16(self, v: u16) -> Result<Self::Ok, Self::Error> { Ok(Value::Number((v as u64).into())) }
    fn serialize_u32(self, v: u32) -> Result<Self::Ok, Self::Error> { Ok(Value::Number((v as u64).into())) }
    fn serialize_u64(self, v: u64) -> Result<Self::Ok, Self::Error> { Ok(Value::Number(v.into())) }
    ...
    fn serialize_bytes(self, v: &[u8]) -> Result<Self::Ok, Self::Error> {
        Ok(Value::Array(v.iter().map(|b| Value::Number((*b as u64).into())).collect()))
    }
    ...
    fn serialize_map(self, _len: Option<usize>) -> Result<Self::SerializeMap, Self::Error> { Ok(MapSerializer { map: Map::new(), next_key: None }) }
    fn serialize_struct(self, _name: &'static str, _len: usize) -> Result<Self::SerializeStruct, Self::Error> { Ok(MapSerializer { map: Map::new(), next_key: None }) }
    fn serialize_struct_variant(self, _name: &'static str, _variant_index: u32, variant: &'static str, _len: usize) -> Result<Self::SerializeStructVariant, Self::Error> {
        Ok(StructVariantSerializer { map: Map::new(), name: variant.to_string() })
    }
}
...
pub struct MapSerializer { map: Map<String, Value>, next_key: Option<String> }
